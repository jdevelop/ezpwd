...
func (e *devEzpwd) passwordMgmtForm(id int, pwds []ezpwd.Password) *tview.Form {
	...
	form.SetBackgroundColor(DefaultColorSchema.PasswordMgmtColors.Background)
	form.SetLabelColor(DefaultColorSchema.PasswordMgmtColors.Label)
	form.SetButtonBackgroundColor(DefaultColorSchema.PasswordMgmtColors.ButtonBackground)
	form.SetButtonTextColor(DefaultColorSchema.PasswordMgmtColors.ButtonText)
	form.SetFieldBackgroundColor(DefaultColorSchema.PasswordMgmtColors.FieldBackground)
	form.SetFieldTextColor(DefaultColorSchema.PasswordMgmtColors.FieldText)
	...
	if id == -1 {
		form.SetBorderColor(DefaultColorSchema.PasswordMgmtColors.BorderAdd)
		form.SetTitleColor(DefaultColorSchema.PasswordMgmtColors.TitleAdd)
		form.SetTitle(" Adding new login ")
	} else {
		p := pwds[id]
		form.SetBorderColor(DefaultColorSchema.PasswordMgmtColors.BorderUpdate)
		form.SetTitleColor(DefaultColorSchema.PasswordMgmtColors.TitleUpdate)
